...
var ProductStore = /** @class */ (function () {
    ...
    ProductStore.prototype.index = function () {
        return __awaiter(this, void 0, void 0, function () {
            var dbConnection, sqlQuery, queryResult, error_1;
    ...
    ProductStore.prototype.show = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var dbConnection, sqlQuery, queryResult, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, dbConnection.query(sqlQuery, [id])];
                    case 2:
                        queryResult = _a.sent();
                        dbConnection.release;
    ...
    ProductStore.prototype.create = function (product) {
        return __awaiter(this, void 0, void 0, function () {
            var dbConnection, sqlQueryI, queryResultI, sqlQuery, queryResult, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                    ...
                    case 3:
                        queryResult = _a.sent();
                        return [2 /*return*/, queryResult.rows[0]];
                    case 4: return [2 /*return*/, { price: -1 }];
                    case 5:
                        error_3 = _a.sent();
